    ...
    recommendations: {
      getOrCreateDaily: async () => ({
        ...
        repositories: [{
          ...
          pushedAt: null,
          facts: { stars: 1200, forks: 60, openIssues: 8, subscribers: 10, license: 'MIT', topics: ['agent'], ageDays: 14, pushedDaysAgo: 0.5 },
          growth: { stars24h: 120, stars7d: 640, forkRate: 0.05 },
          ranking: { bestRank: 3, sources: ['github-search'] },
          history: [{ date: '2026-07-15', stars: 1200, forks: 60 }],
        }],
      }),
    },
    ...
    expect(response.json()).toMatchObject({
      ...
      data: {
        ...
        repositories: [{
          ...
          fullName: 'owner/repo',
          pushedAt: null,
          facts: { stars: 1200, license: 'MIT', topics: ['agent'] },
          growth: { stars24h: 120, stars7d: 640 },
          ranking: { bestRank: 3, sources: ['github-search'] },
          history: [{ date: '2026-07-15', stars: 1200, forks: 60 }],
        }],
      },
